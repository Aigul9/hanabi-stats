"""
Description:
    List of words extracted from players' notes sorted by frequency in descending order.

Columns:
    - Word: a word
    - Frequency: total number of occurrences of the word
    - Vocabulary: number of vocabularies (max = 33)
"""
...
def save_words(word_count_players_dict):
    ...
    with open(f'../../output/notes/frequent_words.tsv', 'w', encoding='utf-8', newline='') as file:
        ...
        w.writerow(['Word', 'Frequency', 'Vocabulary'])
...
if __name__ == "__main__":
    ...
    save_words(most_frequent(users_portraits))
